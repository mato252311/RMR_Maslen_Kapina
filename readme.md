...
# Mobilná robotika – Zadania 1, 3, 4, 5

Projekt implementuje lokalizáciu, mapovanie, plánovanie trajektórie a Monte Carlo lokalizáciu mobilného robota Kobuki pomocou LiDAR senzora.
...
2. Úloha 3 – Mapovanie priestoru
3. Úloha 4 – Plánovanie trajektórie
4. Úloha 5 – Monte Carlo lokalizácia (Particle Filter)
